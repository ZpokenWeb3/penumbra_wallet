...
export class AssetInfo extends jspb.Message {
  getAssetId(): src_proto_crypto_pb.AssetId | undefined;
  setAssetId(value?: src_proto_crypto_pb.AssetId): AssetInfo;
  hasAssetId(): boolean;
  clearAssetId(): AssetInfo;

  getDenom(): src_proto_crypto_pb.Denom | undefined;
  setDenom(value?: src_proto_crypto_pb.Denom): AssetInfo;
  hasDenom(): boolean;
...
export namespace AssetInfo {
  export type AsObject = {
    assetId?: src_proto_crypto_pb.AssetId.AsObject,
    denom?: src_proto_crypto_pb.Denom.AsObject,
    asOfBlockHeight: number,
    totalSupply: number,
  }
}
...
export class CompactBlock extends jspb.Message {
  ...
  getNullifiersList(): Array<src_proto_crypto_pb.Nullifier>;
  setNullifiersList(value: Array<src_proto_crypto_pb.Nullifier>): CompactBlock;
  clearNullifiersList(): CompactBlock;
  addNullifiers(value?: src_proto_crypto_pb.Nullifier, index?: number): src_proto_crypto_pb.Nullifier;

  getBlockRoot(): src_proto_crypto_pb.MerkleRoot | undefined;
  setBlockRoot(value?: src_proto_crypto_pb.MerkleRoot): CompactBlock;
  hasBlockRoot(): boolean;
  clearBlockRoot(): CompactBlock;

  getEpochRoot(): src_proto_crypto_pb.MerkleRoot | undefined;
  setEpochRoot(value?: src_proto_crypto_pb.MerkleRoot): CompactBlock;
  ...
  getSlashedList(): Array<src_proto_crypto_pb.IdentityKey>;
  setSlashedList(value: Array<src_proto_crypto_pb.IdentityKey>): CompactBlock;
  clearSlashedList(): CompactBlock;
  addSlashed(value?: src_proto_crypto_pb.IdentityKey, index?: number): src_proto_crypto_pb.IdentityKey;
...
export namespace CompactBlock {
  export type AsObject = {
    ...
    nullifiersList: Array<src_proto_crypto_pb.Nullifier.AsObject>,
    blockRoot?: src_proto_crypto_pb.MerkleRoot.AsObject,
    epochRoot?: src_proto_crypto_pb.MerkleRoot.AsObject,
    quarantined?: Quarantined.AsObject,
    slashedList: Array<src_proto_crypto_pb.IdentityKey.AsObject>,
...
export class AnnotatedNotePayload extends jspb.Message {
  getPayload(): src_proto_crypto_pb.NotePayload | undefined;
  setPayload(value?: src_proto_crypto_pb.NotePayload): AnnotatedNotePayload;
  hasPayload(): boolean;
...
export namespace AnnotatedNotePayload {
  export type AsObject = {
    payload?: src_proto_crypto_pb.NotePayload.AsObject,
    source?: NoteSource.AsObject,
  }
}

export class KnownAssets extends jspb.Message {
  getAssetsList(): Array<src_proto_crypto_pb.Asset>;
  setAssetsList(value: Array<src_proto_crypto_pb.Asset>): KnownAssets;
  clearAssetsList(): KnownAssets;
  addAssets(value?: src_proto_crypto_pb.Asset, index?: number): src_proto_crypto_pb.Asset;
...
export namespace KnownAssets {
  export type AsObject = {
    assetsList: Array<src_proto_crypto_pb.Asset.AsObject>,
  }
}
...
export class GenesisAppState extends jspb.Message {
  ...
  getValidatorsList(): Array<src_proto_stake_pb.Validator>;
  setValidatorsList(value: Array<src_proto_stake_pb.Validator>): GenesisAppState;
  clearValidatorsList(): GenesisAppState;
  addValidators(value?: src_proto_stake_pb.Validator, index?: number): src_proto_stake_pb.Validator;
...
export namespace GenesisAppState {
  export type AsObject = {
    ...
    validatorsList: Array<src_proto_stake_pb.Validator.AsObject>,
  ...
  export class Allocation extends jspb.Message {
    ...
    getAddress(): src_proto_crypto_pb.Address | undefined;
    setAddress(value?: src_proto_crypto_pb.Address): Allocation;
    hasAddress(): boolean;
  ...
  export namespace Allocation {
    export type AsObject = {
      amount: number,
      denom: string,
      address?: src_proto_crypto_pb.Address.AsObject,
    }
  }
...
export namespace Quarantined {
  ...
  export class Unbonding extends jspb.Message {
    ...
    getNullifiersList(): Array<src_proto_crypto_pb.Nullifier>;
    setNullifiersList(value: Array<src_proto_crypto_pb.Nullifier>): Unbonding;
  ...
  export class ValidatorEntry extends jspb.Message {
    ...
    setIdentityKey(value?: src_proto_crypto_pb.IdentityKey): ValidatorEntry;
...
export class Slashed extends jspb.Message {
  getValidatorsList(): Array<src_proto_crypto_pb.IdentityKey>;
  setValidatorsList(value: Array<src_proto_crypto_pb.IdentityKey>): Slashed;
  clearValidatorsList(): Slashed;
  addValidators(value?: src_proto_crypto_pb.IdentityKey, index?: number): src_proto_crypto_pb.IdentityKey;
...
export namespace Slashed {
  export type AsObject = {
    validatorsList: Array<src_proto_crypto_pb.IdentityKey.AsObject>,
  }
}
